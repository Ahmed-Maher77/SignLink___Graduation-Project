...
class AppConfig:
    ...
    GRAMMAR_API_MODEL = "mistralai/mistral-small-3.2-24b-instruct:free"
    GRAMMAR_SYSTEM_PROMPT = "Correct the grammar and punctuation of the following sentence without adding any new information or nouns or text and without removing any existing words, respond with ONLY the corrected sentence ONLY."
